 ...
 * MentionsFixture
 */
class MentionsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'mention_date' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'talent_id' => 1,
                'mention_date' => '2019-08-21 04:11:09',
                'project_id' => 1,
                'task_id' => 1,
                'user_id' => 1
            ],
