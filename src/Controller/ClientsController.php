...
//        ];
    ...
    public function isAuthorized($user)
    {
        ...
        if(in_array($this->request->getParam('action'),['view','edit'])&&($user['permission_view_full_client_list']==1)){

            return true;
        }

        if(in_array($this->request->getParam('action'),['view','edit'])&&($user['permission_view_limited_client_list']==1)){
