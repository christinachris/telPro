            ...
            <div class="kt-subheader   kt-grid__item" id="kt_subheader">
                <div class="kt-subheader__main">
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <span class="kt-subheader__breadcrumbs-separator"></span>
                        <a href="<?php echo $this->Url->build(['controller' => 'SkillCategories', 'action' => 'index']) ?>" class="kt-subheader__breadcrumbs-link">
                            Skill Categories List
                        </a>
                        <span class="kt-subheader__breadcrumbs-separator"></span>

                        <span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Add New Skill Category</span>
                    </div>
                </div>
                            ...
                            <form class="kt-form kt-form--label-right">
                                <div class="kt-portlet__body" style="margin-left:55px">
                                    <div class="form-group row">
                                        <div class="col-lg-4">
                                            <?php echo $this->Form->control('name', ['class' => 'form-control', 'placeholder' => "Enter new Skill Category's name"]); ?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-lg-8">
                                            <?php echo $this->Form->control('description', ['class' => 'form-control', 'placeholder' => "Enter new Skill Category's description",'type'=>'textarea']); ?>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div style="width: 100%;display: flex; align-items: center; justify-content: center;">
                                    ...
                                    <?php echo $this->Html->link('Cancel',
                                        array('controller' => 'SkillCategories',
                                            'action' => 'index',
                                            'type' => 'button'),
