 ...
 * @var \App\Model\Entity\SkillCategory[]|\Cake\Collection\CollectionInterface $skillCategories
 */
?>
        ...
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
            ...
            <div class="kt-subheader   kt-grid__item" id="kt_subheader">
                <div class="kt-subheader__main">
                    ...
                    <span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active"> Skill Categories List</span>
                            ...
                            <div class="kt-portlet__head-toolbar">
                                <div class="kt-portlet__head-wrapper">
                                    ...
                                    <div class="dropdown dropdown-inline">
                                        ...
                                        <?= $this->Html->link('<span class="btn btn-primary"><i class="flaticon2-plus"></i> Add Skill Categories</span>', ['controller' => 'SkillCategories', 'action' => 'add', 'type' => 'button'], ['escape' => false]) ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div
                                ...
                                <table class="table" id="myTalentTable">
                                    ...
                                    <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                                        ...
                                        <td data-field="ShipDate" class="kt-datatable__cell">
                                            <span ><?= h($skillCategory->name) ?></span>
                                        </td>

                                        <td data-field="ShipDate" class="kt-datatable__cell">
                                            <span style=""><?= h($skillCategory->description) ?></span>
                                        </td>
                                        <td class="kt-datatable__cell--left kt-datatable__cell" data-field="Actions"
                                            data-autohide-disabled="false">
                                                   <span style="overflow: visible; position: relative; width: 100px;">
                                                        <?= $this->Html->link('<span class= "btn btn-sm btn-clean btn-icon btn-icon-sm"  ><i class="flaticon2-note" style="padding : 5px ; font-size: 20px" ></i></span>', ['action' => 'edit', $skillCategory->id],['escape' => false, 'data-toggle'=>"kt-popover",'data-content'=>"Edit Skill Category",'data-placement'=>'bottom']) ?>
                                                    </span>
                                            <?= $this->Form->postLink(' ', ['action' => 'delete', $skillCategory->id], ['confirm' => __('Are you sure you want to archive this Skill Category?'), 'class' => "btn btn-lg btn-clean flaticon2-delete",'style' => 'color:red ; padding : 5px ; font-size: 20px', 'data-toggle' => "kt-popover", 'data-content' => "Delete Skill Category", 'data-placement' => 'bottom'], ['confirm' => __('Are you sure you want to delete {0}?',  $skillCategory->name)]) ?>
...
<div class="skillCategories index large-9 medium-8 columns content">
