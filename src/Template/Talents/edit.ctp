                ...
                <div class="kt-subheader__main">
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <a href="<?php echo $this->Url->build(['controller' => 'Talents',
                            'action' => 'index']) ?>" class="kt-subheader__breadcrumbs-link">
                            Talents List
                        </a>
                        <span class="kt-subheader__breadcrumbs-separator"></span>

                        <span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Talent Details</span>
                    </div>
                </div>
                        ...
                        <fieldset>
                            ...
                            <form class="kt-form kt-form--label-right">
                                <div class="kt-portlet__body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            <?php echo $this->Form->control('address', ['class' => 'form-control', 'id' => 'exampleSelect1', 'placeholder' => "Enter New Talent's Address"]); ?>
                                            <div class="kt-input-icon">
                                                <span class="kt-input-icon__icon kt-input-icon__icon--right"><span></span></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            <?php echo $this->Form->control('position', ['options' => array('' => '', 'Superadmin' => 'Superadmin', 'Admin' => 'Admin', 'Project Manager' => 'Project Manager', 'Full-time' => 'Full-time', 'Part-time' => 'Part-time', 'Casual' => 'Casual', 'Freelancer' => 'Freelancer'), 'empty' => true, 'class' => 'form-control', 'id' => 'exampleSelect1', 'style' => 'font-size:12px;height:35px;']); ?>
                                            <div class="kt-input-icon">
                                                <div class="kt-input-icon">
                                        <span
                                            class="kt-input-icon__icon kt-input-icon__icon--right"><span></span></span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <!--<div class="col-lg-3">
                                                <?php echo $this->Form->control('occupied', ['label' => 'Occupied', 'class' => 'form-control', 'type' => 'checkbox']); ?>
                                                <div class="kt-input-icon">
                                                    <span class="kt-input-icon__icon kt-input-icon__icon--right"><span></span></span>
                                                </div>
                                                <span class="form-text text-muted">Please enter new talent's address</span>
                                                -->
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-lg-4">
                                            <!--<?php
                                            if ($talent->occupied == 1):
                                                echo $this->Form->control('occupied', ['type' => 'checkbox', 'checked', 'id' => 'occupied', 'value' => 'true']);
                                            else:
                                                echo $this->Form->control('occupied', ['type' => 'checkbox', 'id' => 'occupied', 'value' => 'true']);
                                            endif;
                                            ?> -->
