                            ...
                            <div class="kt-portlet__head-toolbar">
                                <div class="kt-portlet__head-wrapper">
                                    ...
                                    <div class="dropdown dropdown-inline">
                                        ...
                                        <?= $this->Html->link('<span class="btn btn-primary"><i class="flaticon2-plus"></i> Add New User</span>', ['controller' => 'Users', 'action' => 'add', 'type' => 'button'], ['escape' => false]) ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div
                                ...
                                <table class="table" id="myTalentTable">
                                    ...
                                    <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                                        ...
                                        <td data-field="ShipDate" class="kt-datatable__cell">
                                            <span style=""><?= h($user->username) ?></span>
                                        </td>
                                        <td data-field="ShipDate" class="kt-datatable__cell">
                                            <span style=""><?= h($user->password) ?></span>
                                        </td>
                                        <td data-field="ShipDate" class="kt-datatable__cell">
                                            <span style=""><?= h($user->role) ?></span>
                                        </td>
                                        <td data-field="ShipDate" class="kt-datatable__cell">
                                            <span style=""><?= h($user->created) ?></span>
                                        </td>
                                        <td data-field="ShipDate" class="kt-datatable__cell">
                                            <span style=""><?= h($user->modified) ?></span>
                                        </td>
                                        <td class="kt-datatable__cell--left kt-datatable__cell" data-field="Actions"
                                            data-autohide-disabled="false">
                                                   <span style="overflow: visible; position: relative; width: 100px;">
                                                        <?= $this->Html->link('<span class= "btn btn-sm btn-clean btn-icon btn-icon-sm"  ><i class="flaticon2-note" style="padding : 5px ; font-size: 20px" ></i></span>', ['action' => 'edit', $user->id],['escape' => false, 'data-toggle'=>"kt-popover",'data-content'=>"Edit User",'data-placement'=>'bottom']) ?>
                                                    </span>
                                            <?= $this->Form->postLink(' ', ['action' => 'delete', $user->id], ['confirm' => __('Are you sure you want to delete this user?'), 'class' => "btn btn-lg btn-clean la la-close",'style' => 'color:red ; padding : 5px ; font-size: 25px', 'data-toggle' => "kt-popover", 'data-content' => "Delete User", 'data-placement' => 'bottom'], ['confirm' => __('Are you sure you want to delete {0}?',  $user->name)]) ?>
