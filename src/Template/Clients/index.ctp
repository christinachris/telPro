...
?>
                                                ...
                                                <td class="kt-datatable__cell--left kt-datatable__cell" data-field="Actions" data-autohide-disabled="false">
                                                    ...
                                                    <a >
                                                        ...
                                                        <?= $this->Form->postLink(' ', ['action' => 'archive', $client->id], ['confirm' => __('Are you sure you want to archive this client?'), 'class' => "btn btn-lg btn-clean  la la-archive",'style' => 'padding : 5px ; font-size: 25px', 'data-toggle' => "kt-popover", 'data-content' => "Archive Client", 'data-placement' => 'bottom'], ['confirm' => __('Are you sure you want to delete {0}?',  $client->first_name.' '.$client->last_name)]) ?>
                                                                            ...
                                                                            <fieldset>
                                                                                        <div class="form-group row">
                                                                                            <div class="col-lg-4">
                                                                                                ...
                                                                                                <?php echo $this->Form->hidden('talent_id', ['class' => 'form-control', 'type' => 'textarea']); ?>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group row">
                                                                                            <div class="col-lg-12">
                                                ...
                                                <div class="modal-body">
                                                                        <span>
                                                                            ...
                                                                            <fieldset>
                                                                                        ...
                                                                                        <div class="form-group row">
                                                                                            <div class="col-lg-4">
                                                                                                <?php echo $this->Form->control('type', ['class' => 'form-control', 'empty' => '--select--', 'options' => array('' => '', 'Email' => 'Email', 'Phone Call' => 'Phone Call')]); ?>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group row">
                                                                                            <div class="col-lg-4">
