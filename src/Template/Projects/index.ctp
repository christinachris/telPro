                ...
                <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
                    <div class="kt-portlet kt-portlet--mobile">
                        <div class="kt-portlet__head kt-portlet__head--lg"
                             style="border-bottom: none ; padding-top: 20px ; padding-bottom: 30px">
                        ...
                        <div class="kt-portlet__body kt-portlet__body--fit" style="padding-top: 25px">
                            ...
                            <table class="table" id="myTable">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 15% ;text-align: center"><?= $this->Paginator->sort('project_name') ?></th>
                                    <th style="width: 20% ;text-align: center"><?= $this->Paginator->sort('progress_num') ?></th>
                                    <th style="width: 7% ;text-align: center"><?= $this->Paginator->sort('start_date') ?></th>
                                    <th style="width: 7% ;text-align: center"><?= $this->Paginator->sort('end_date') ?></th>
                                ...
                                <?php foreach ($projects as $project): ?>
                                    <tr id="count">
                                        ...
                                        <td>
                                            <div class="progress"
                                                 style="font-size: 15px ;height: 20px ; font-weight: 500">
                                                <div
